...
public class TwoInstrumentCorrelation2 implements IIndicator, IChartInstrumentsListener {
    ...
    public void onStart(IIndicatorContext context) {
        ...
        optInputParameterInfos = new OptInputParameterInfo[] {
                ...
                new OptInputParameterInfo("Instrument1 Factor", OptInputParameterInfo.Type.OTHER,
                        new DoubleRangeDescription(a1, 0, 2000, 0.1, 5)),
                new OptInputParameterInfo("Instrument1 Constant", OptInputParameterInfo.Type.OTHER,
                        new DoubleRangeDescription(b1, -2000, 2000, 0.01, 5)),
                new OptInputParameterInfo("Instrument2 Factor", OptInputParameterInfo.Type.OTHER,
                        new DoubleRangeDescription(a2, 0, 2000, 0.1, 5)),
                new OptInputParameterInfo("Instrument2 Constant", OptInputParameterInfo.Type.OTHER,
