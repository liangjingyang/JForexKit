...
public class myOfflineTrades extends SubStrategy {
    ...
    public static final String STRATEGY_TAG = myOfflineTrades.class.getSimpleName();
    ...
    public void onStart(IContext context) throws JFException {
        ...
        myInstrument = (Instrument) helper.getInstrumentSet().toArray()[0];
        myForm = new OfflineForm();
        // avoid to run outside of Historical Tester
        if (mEngine.getType() != IEngine.Type.TEST){
    ...
    public void onTick(Instrument instrument, ITick tick) throws JFException {
        if (helper.isStrategyInstrument(instrument)){ // filter
            myForm.updatePrices(tick);
            // get orders
            List<IOrder> myAllOrders = mEngine.getOrders();
    ...
    public void print(String string){
        mConsole.getOut().println(string);
    }//end print
    ...
    class OfflineForm extends  JFrame implements ActionListener{
            ...
            jTableOrders.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if ((row + 1) % 3 == 1 && col == 1){
                        ...
                        IOrder order = mEngine.getOrderById(orderId);
        ...
        private void placeOrder(String orderType) throws JFException {
            ...
            if (jRadioButtonMarket.isSelected()){
                myOrder = mEngine.submitOrder(orderType + myOrderCounter, myInstrument, myOrderCommand, myAmount, 0, mySlippage);
                myOrderCounter++;
            } else {
                myOrder = mEngine.submitOrder(orderType + myOrderCounter, myInstrument, myOrderCommand, myAmount, myEntry, mySlippage);
                myOrderCounter++;
            }
        }// end placeOrder
        ...
        public void setTpSl(IOrder order) throws JFException{
            double myPipValue = order.getInstrument().getPipValue();
