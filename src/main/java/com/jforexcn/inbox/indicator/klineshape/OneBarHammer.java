...
public class OneBarHammer implements IIndicator {
    ...
    private int barMinPips = 10;
    private int breakPips = 5;
    private int lookback = 2;

    private double bodyRate = 0.35;
    private double shortShadowRate = 0.15;
    private double longShadowRate = 0.5;
    ...
    public void onStart(IIndicatorContext context) {
        ...
        indicatorInfo =
                new IndicatorInfo("OneBarHammer", "Bar Break", "Custom IIndicator", true, false, false, 1, 6, 2);
