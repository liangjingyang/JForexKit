...
public class GSRatio implements IIndicator, IDrawingIndicator {
    ...
    public void onStart(IIndicatorContext context) {
        ...
        //indicator info
        indicatorInfo = new IndicatorInfo("GSRatio", "MA for various instruments", "", true, false, true, 2, 2, 2);

        //indicator inputs
//        InputParameterInfo gbpUsdInput = new InputParameterInfo("Input data", InputParameterInfo.Type.BAR);
//        gbpUsdInput.setInstrument(Instrument.XAUUSD);
        InputParameterInfo xagUsdInput = new InputParameterInfo("Input data", InputParameterInfo.Type.BAR);
        xagUsdInput.setInstrument(Instrument.XAGUSD);

        inputParameterInfos = new InputParameterInfo[] {
                new InputParameterInfo("Input data", InputParameterInfo.Type.BAR), xagUsdInput};
...
//        OutputParameterInfo gbpUsdOutput = new OutputParameterInfo("gbpUsd_MA", OutputParameterInfo.Type.DOUBLE, OutputParameterInfo.DrawingStyle.LINE);
        OutputParameterInfo xagUsdOutput = new OutputParameterInfo("XAG MA", OutputParameterInfo.Type.DOUBLE, OutputParameterInfo.DrawingStyle.LINE);
...
//        gbpUsdOutput.setDrawnByIndicator(true);
        xagUsdOutput.setDrawnByIndicator(true);
