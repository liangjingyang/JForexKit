 ...
 */
public class ATRPercentage implements IIndicator {
    ...
    public void onStart(IIndicatorContext context) {
        ...
        indicatorInfo = new IndicatorInfo("VOLATILITYATRPERCENT", "Volatility ATR Percent"
                , "Custom indicators", true, false, true, 4, 5, 3);
