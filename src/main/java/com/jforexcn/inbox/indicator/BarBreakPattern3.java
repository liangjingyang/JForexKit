...
public class BarBreakPattern3 implements IIndicator {
    ...
    private int breakBarOutOfRectPips = 10;
    private int minLookback = 10;
    private int maxLookback = 200;
    private int rectHeightLimit = 30;
    ...
    public void onStart(IIndicatorContext context) {
        ...
        indicatorInfo =
                new IndicatorInfo("sBARBREAK3", "Bar Break", "Pattern Recognition", true, false, false, 1, 5, 2);
        ...
        optInputParameterInfos = new OptInputParameterInfo[]{
                ...
                new OptInputParameterInfo("Rect Height Limit", OptInputParameterInfo.Type.OTHER
...
//        console.getInfo().println("startIndex: " + startIndex + ". endIndex: " + endIndex);
        ...
        for (k = startIndex, l = 0; k <= endIndex; k++, l++) {
            ...
            for (i = k - 1, m = 1; i >= k - maxLookback; i--, m++) {
                double prevAtr = rectHeightLimit * pipValue;
...
//                                chart.add(textChartObject);
    ...
    private class BreakPattern {
        ...
        boolean checkAtr(double atr) {
            return section.getTop() - section.getBottom() < atr;
        }
